...
import { installRound512MatchLinks } from './round51-2-match-center-links.mjs';
...
if (typeof globalThis.document !== 'undefined') installRound512MatchLinks(globalThis.document);
