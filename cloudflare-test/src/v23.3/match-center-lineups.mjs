...
@media(min-width:540px){.cw233-mc-lineup-text,.cw250-mc-lineup-text{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start}.cw233-mc-lineup-pitch,.cw250-mc-lineup-pitch{width:min(100%,328px)}}@media(max-width:420px){.cw233-mc-lineup-stage,.cw250-mc-lineup-stage{padding:9px}.cw250-mc-pitch-head{padding-inline:1px}.cw233-mc-lineup-pitch,.cw250-mc-lineup-pitch,.cw233-mc-pitch-unavailable,.cw250-mc-pitch-unavailable{width:min(100%,286px)}.cw233-mc-pitch-player,.cw250-mc-pitch-player{width:58px}.cw251-mc-pitch-name{max-width:58px!important;font-size:7px!important}.cw251-mc-pitch-badge{font-size:7px}}@media(max-width:339px){.cw233-mc-lineup-pitch,.cw250-mc-lineup-pitch{width:min(100%,246px)}.cw250-mc-pitch-head{grid-template-columns:minmax(0,1fr) auto}.cw250-mc-formation-badge{padding:4px 6px}.cw233-mc-pitch-player,.cw250-mc-pitch-player{width:52px}.cw251-mc-pitch-name{max-width:52px!important;font-size:7px!important}}
</style>`;
