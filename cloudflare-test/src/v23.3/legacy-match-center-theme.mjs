...
export const LEGACY_MATCH_CENTER_THEME_BUILD = 'r22-style-polish';
...
const CSS = `
#ciao-miniapp-root[data-cw233-mc-competition] {
  --cw233-mc-bg:#07162e;
...
#ciao-miniapp-root[data-cw233-mc-competition="coppa_italia"] {
  --cw233-mc-bg:#17090f;
...
#ciao-miniapp-root[data-cw233-mc-competition="ucl"],
#ciao-miniapp-root[data-cw233-mc-competition="champions_league"] {
  --cw233-mc-bg:#080b29;
  --cw233-mc-surface:rgba(255,255,255,.055);
...
#ciao-miniapp-root[data-cw233-mc-competition="uel"],
#ciao-miniapp-root[data-cw233-mc-competition="europa_league"] {
  --cw233-mc-bg:#160d08;
  --cw233-mc-surface:rgba(255,255,255,.052);
  --cw233-mc-surface-strong:rgba(255,255,255,.075);
...
#ciao-miniapp-root[data-cw233-mc-competition="uecl"],
#ciao-miniapp-root[data-cw233-mc-competition="conference_league"] {
  --cw233-mc-bg:#06170f;
  --cw233-mc-surface:rgba(255,255,255,.052);
  --cw233-mc-surface-strong:rgba(255,255,255,.075);
...
#ciao-miniapp-root[data-cw233-mc-competition] .mc-shell {
  background:
    radial-gradient(105% 48% at 50% -12%, var(--cw233-mc-glow), transparent 68%),
    var(--cw233-mc-bg);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-toolbar,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-tabs-wrap {
  background:color-mix(in srgb, var(--cw233-mc-bg) 88%, transparent);
  border-color:var(--cw233-mc-border);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-back {
  border-color:var(--cw233-mc-border);
  background:var(--cw233-mc-surface);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-back:active {
  background:var(--cw233-mc-surface-strong);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-hero {
  border-color:var(--cw233-mc-border);
  background:
...
#ciao-miniapp-root[data-cw233-mc-competition] .mc-status {
  border-color:var(--cw233-mc-border);
  background:var(--cw233-mc-surface);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-tabs {
  border-color:var(--cw233-mc-border);
  background:var(--cw233-mc-surface);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-tab.active {
  color:#fff;
...
#ciao-miniapp-root[data-cw233-mc-competition] .mc-section,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-key,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-lineup,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-rating-row,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-event {
  border-color:var(--cw233-mc-border);
  background:var(--cw233-mc-surface);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-section-title,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-key strong,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-rating {
  color:color-mix(in srgb, var(--cw233-mc-accent-2) 52%, white 48%);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-bar.home i,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-momentum-bar.home i {
  background:linear-gradient(90deg,var(--cw233-mc-accent),var(--cw233-mc-accent-2));
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-bar.away i,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-momentum-bar.away i {
  background:var(--cw233-mc-away);
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-shot.home {
  background:var(--cw233-mc-accent-2);
  border-color:#fff;
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-shot.away {
  background:var(--cw233-mc-away);
  border-color:#fff;
}
#ciao-miniapp-root[data-cw233-mc-competition] .mc-shirt,
#ciao-miniapp-root[data-cw233-mc-competition] .mc-rating {
  border-color:var(--cw233-mc-border);
