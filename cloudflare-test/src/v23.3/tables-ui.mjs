...
function teamLogo(team) {
  ...
  return url
    ? `<img class="cw233-table-logo" src="${esc(url)}" alt="" loading="eager" decoding="sync">`
...
.cw233-table-selectors-viewport{width:100%;max-width:100%;overflow-x:auto;overflow-y:hidden;overscroll-behavior-x:contain;-webkit-overflow-scrolling:touch;scrollbar-width:none;margin:0 0 18px;padding:0 0 4px}.cw233-table-selectors-viewport::-webkit-scrollbar{display:none;width:0;height:0}.cw233-table-selectors{display:flex;gap:8px;min-width:max-content}.cw233-table-selector{min-height:42px;border:1px solid rgba(255,255,255,.1);border-radius:14px;padding:0 14px;background:rgba(255,255,255,.055);color:rgba(255,255,255,.7);font:800 12px/1 inherit;white-space:nowrap}.cw233-table-selector.is-active{background:#fff;color:#07101f;border-color:#fff}.cw233-tables-content{min-width:0;max-width:100%}
.cw233-standing-viewport{width:100%;max-width:100%;overflow-x:hidden;border:0;border-radius:0;background:transparent}.cw233-standing-table{width:100%;min-width:0!important;table-layout:fixed;border-collapse:separate;border-spacing:0 8px;font-size:12px}.cw233-standing-table th{padding:7px 6px;color:rgba(151,168,214,.72);font-size:9px;letter-spacing:.08em;text-transform:uppercase;text-align:center;border:0}.cw233-standing-table th:nth-child(1){width:38px}.cw233-standing-table th:nth-child(2){text-align:left}.cw233-standing-table th:nth-child(3){width:42px}.cw233-standing-table th:nth-child(4){width:48px}.cw233-standing-table th:nth-child(5){width:42px}.cw233-standing-table td{height:58px;padding:8px 6px;text-align:center;border-top:1px solid rgba(128,148,198,.16);border-bottom:1px solid rgba(128,148,198,.16);background:linear-gradient(180deg,rgba(19,31,51,.98),rgba(13,23,38,.98));font-variant-numeric:tabular-nums}.cw233-standing-table td:first-child{border-left:1px solid rgba(128,148,198,.16);border-radius:16px 0 0 16px}.cw233-standing-table td:last-child{border-right:1px solid rgba(128,148,198,.16);border-radius:0 16px 16px 0}.cw233-standing-position{font-weight:850;color:#7da0ff}.cw233-standing-team{text-align:left!important;display:flex;align-items:center;gap:9px;min-width:0}.cw233-standing-team strong{min-width:0;overflow:hidden;text-overflow:ellipsis;font-size:12px;white-space:nowrap}.cw233-table-logo{width:30px;height:30px;object-fit:contain;flex:0 0 30px}.cw233-table-logo--empty{border-radius:50%;background:rgba(80,106,160,.22);border:1px solid rgba(117,144,203,.18)}.cw233-table-logo-fallback{display:inline-flex;align-items:center;justify-content:center;color:#b9c5ec;font-size:9px;font-weight:900}.cw233-standing-goal-difference{font-weight:750;color:rgba(225,232,250,.86)}.cw233-standing-points{font-weight:900;font-size:13px;color:#fff}
#${OVERLAY_ID} .cw233-standing-table th:nth-child(4),#${OVERLAY_ID} .cw233-standing-table td:nth-child(4),#${OVERLAY_ID} .cw233-standing-table th:nth-child(5),#${OVERLAY_ID} .cw233-standing-table td:nth-child(5){display:table-cell!important}
...
@media(max-width:390px){#${OVERLAY_ID}{padding-left:12px;padding-right:12px}.cw233-tables-head h2{font-size:27px}.cw233-table-selector{padding:0 12px;font-size:11px}.cw233-standing-legend__items{grid-template-columns:1fr}.cw233-standing-table th:nth-child(1){width:34px}.cw233-standing-table th:nth-child(3){width:36px}.cw233-standing-table th:nth-child(4){width:42px}.cw233-standing-table th:nth-child(5){width:36px}.cw233-standing-table td{padding-left:4px;padding-right:4px}.cw233-table-logo{width:28px;height:28px;flex-basis:28px}.cw233-standing-team{gap:7px}}
`;
