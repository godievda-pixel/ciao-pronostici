...
const TABLES_CSS = `
#${OVERLAY_ID}{position:fixed;inset:0;z-index:43;overflow-y:auto;overflow-x:hidden;overscroll-behavior:contain;background:#07101f;color:#fff;padding:calc(18px + env(safe-area-inset-top,0px)) 16px calc(104px + env(safe-area-inset-bottom,0px));font-family:inherit;-webkit-overflow-scrolling:touch}
