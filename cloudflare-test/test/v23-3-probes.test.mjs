...
test('v23.3 BSD provider probe covers full external tournament release evidence', async () => {
  ...
  for (const competition of ['coppa_italia', 'ucl', 'uel', 'uecl']) assert.match(source, new RegExp(competition));
...
test('v23.3 deployment probe verifies current runtime and every release surface', async () => {
...
test('v23.3 workflow uploads explicitly versioned provider and deployment evidence', async () => {
  ...
  assert.match(workflow, /probe-test-deployment-v233\.mjs/);
});