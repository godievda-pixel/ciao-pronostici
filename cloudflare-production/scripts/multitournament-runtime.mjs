...
#ciao-miniapp-root .cwmt-cover{position:relative;min-height:92px;border-radius:21px;padding:17px 16px 15px 58px;margin-bottom:12px;display:flex;align-items:flex-end;overflow:hidden;border:1px solid rgba(255,255,255,.12);box-shadow:0 14px 30px rgba(0,0,0,.18)}\
#ciao-miniapp-root .cwmt-cover h2{margin:0;color:#fff;font-size:24px;line-height:1.03;letter-spacing:-.035em}\
#ciao-miniapp-root .cwmt-back{position:absolute;left:13px;top:13px;width:36px;height:36px;border-radius:12px;border:1px solid rgba(255,255,255,.18);background:rgba(4,10,30,.28);color:#fff;font-size:28px;line-height:1}\
